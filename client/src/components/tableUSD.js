      ...
      <Table bordered>
        ...
        <tbody>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[0] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[1] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[2] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[3] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[4] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[5] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[6] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[7] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[8] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[9] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[10] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[11] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[12] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[13] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[14] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[15] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[16] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[17] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[18] + "%"}</td>
          </tr>
          <tr>
            ...
            <td style={tdstyle}>{this.state.PriceChange[19] + "%"}</td>
          </tr>
        </tbody>
      </Table>
    </div>
